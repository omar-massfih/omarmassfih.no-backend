...
class Settings:
    ...
    embedding_model: str = os.getenv("EMBEDDING_MODEL") or "BAAI/bge-small-en-v1.5"
    embedding_dim: int = int(os.getenv("EMBEDDING_DIM") or "384")
    embedding_cache_dir: str = os.getenv("EMBEDDING_CACHE_DIR") or ".cache/fastembed"
    embedding_threads: int = int(os.getenv("EMBEDDING_THREADS") or "2")
    ...
    def __post_init__(self) -> None:
        ...
        if self.embedding_threads <= 0:
            raise ValueError("EMBEDDING_THREADS must be greater than zero")
